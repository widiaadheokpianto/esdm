<?php $thisPage="Edit Karyawan"; ?>
<?php $title = "Edit Karyawan | E-SDM BKD v1.0" ?>
<?php $description = "Edit Karyawan | E-SDM BKD v1.0" ?>
<?php 
...
?>
	<div class="container">
		<div class="content">
			...
			$sql = mysqli_query($koneksi, "SELECT * FROM tbl_karyawan WHERE nip='$nip'"); // query untuk memilih entri data dengan nilai nip terpilih
			...
			if(isset($_POST['save'])){ // jika tombol 'Simpan' dengan properti name="save" ditekan
				...
				$update = mysqli_query($koneksi, "UPDATE tbl_karyawan SET username='$username', level='$level', nip='$nip', nama='$nama', jenis_kelamin='$jenis_kelamin', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', alamat='$alamat', no_npwp='$no_npwp', no_askes='$no_askes', no_karpeg='$no_karpeg', nik='$nik',golruang='$golruang', eselon='$eselon' WHERE nip='$nip'") or die(mysqli_error()); // query untuk mengupdate nilai entri dalam database
				if($update){ // jika query update berhasil dieksekusi
					header("Location: edit_karyawan.php?nip=".$nip."&pesan=sukses"); // tambahkan pesan=sukses pada url
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="no_npwp" value="<?php echo $row ['no_npwp']; ?>" class="form-control" placeholder="NO NPWP">
					</div>
				</div>
				<div class="form-group">
