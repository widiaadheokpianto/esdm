	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
		  <ul class="nav navbar-nav navbar-left">
			...
			<li<?php if ($thisPage=="Tambah") echo " class=\"active\""; ?>><a href="tambah.php" data-toggle="tooltip" data-placement="bottom" title="Tambah Data Karyawan" ><span class="glyphicon glyphicon-user"></span> Tambah Data</a></li>
			<form name="cari" method="post" action="cari.php" role="search" class="navbar-form navbar-left">
				<div class="form-group">
					<input type="text" name="carinip" placeholder="Cari NIP Karyawan" class="form-control">
				</div>
